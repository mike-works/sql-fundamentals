...
CREATE OR REPLACE VIEW V_CustomerLeaderboard AS (
  SELECT
...
CREATE OR REPLACE VIEW V_EmployeeLeaderboard AS (
  SELECT
...
CREATE OR REPLACE VIEW V_ProductLeaderboard AS (
  SELECT
...
CREATE OR REPLACE VIEW V_RecentOrders AS (
  SELECT
    o.id,
